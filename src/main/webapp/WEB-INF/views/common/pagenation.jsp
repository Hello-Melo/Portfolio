...
$(function(){
	...
	$('.pagination a').on('click',function(e){
		...
		pageForm.append($('<input/>', {type:'hidden',name:'type',value:'${pageMaker.criteria.type}'}));
		pageForm.append($('<input/>', {type:'hidden',name:'keyword',value:'${pageMaker.criteria.keyword}'}));
